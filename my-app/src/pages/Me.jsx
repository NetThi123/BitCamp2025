...
function Me() {
  ...
  return (
    <div className="container">
      <h2 class="myInfoHead">MY INFO:</h2>
      <form className="user-form" onSubmit={handleSubmit}> {/* Added onSubmit */}
        <label>
          NAME:
          <br></br>
        ...
        <button type="submit" className="me-button">Submit Changes</button> {/* Submit button */}
      </form>

      {submitted && (
        <div className="preview">
          <h2 class="myInfoHead">Preview:</h2>
